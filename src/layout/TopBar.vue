  ...
  >
    ...
    >
      ...
      <ul class="navbar-nav flex-row align-items-center ms-auto">
            ...
            <li>
              ...
              >
                <span class="align-middle"
                  ><i class="ri-sun-line ri-22px me-3"></i>Light</span
                >
              </a>
            </li>
            <li>
              ...
              >
                <span class="align-middle"
                  ><i class="ri-moon-clear-line ri-22px me-3"></i>Dark</span
                >
              </a>
            </li>
            <li>
              ...
              >
                <span class="align-middle"
                  ><i class="ri-computer-line ri-22px me-3"></i>System</span
                >
              </a>
            </li>
          </ul>
        ...
        <!-- Notification -->
        <li
          class="nav-item dropdown-notifications navbar-dropdown dropdown me-4 me-xl-1"
        >
          <a
            class="nav-link btn btn-text-secondary rounded-pill btn-icon dropdown-toggle hide-arrow"
            href="javascript:void(0);"
            ...
            <li class="dropdown-menu-header border-bottom py-50">
              <div class="dropdown-header d-flex align-items-center py-2">
                ...
                <div class="d-flex align-items-center">
                  <span
                    class="badge rounded-pill bg-label-primary fs-xsmall me-2"
                    >8 New</span
                  >
                  <a
                    href="javascript:void(0)"
                ...
                >
                  <div class="d-flex">
                    <div class="flex-shrink-0 me-3">
                      <div class="avatar">
                        <img
                          src="../../public/assets/img/avatars/2.png"
                          alt
                          class="rounded-circle"
                        />
                      </div>
          ...
          <ul class="dropdown-menu dropdown-menu-end">
            ...
            <li>
              ...
              >
                <span class="d-flex align-items-center align-middle">
                  ...
                  <span
                    class="flex-shrink-0 badge badge-center rounded-pill bg-danger"
                    >4</span
                  >
                </span>
              </a>
            ...
            <li>
              <a class="dropdown-item" href="pages-faq.html">
                <i class="ri-question-line ri-22px me-3"></i
