  ...
  <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo">
      <a href="index.html" class="app-brand-link">
        ...
        <span class="app-brand-text demo menu-text fw-semibold ms-2">MERP</span>
      </a>
    ...
    <ul class="menu-inner py-1">
      ...
      <li class="menu-item">
        ...
        <ul class="menu-sub">
          ...
          <li class="menu-item">
            <a
              href="https://demos.pixinvent.com/materialize-html-admin-template/html/horizontal-menu-template"
              class="menu-link"
              target="_blank"
            >
      ...
      <li class="menu-item">
        ...
        <ul class="menu-sub">
          <li class="menu-item">
            <a
              href="https://demos.pixinvent.com/materialize-html-admin-template/html/front-pages/landing-page.html"
              class="menu-link"
              target="_blank"
            >
          ...
          <li class="menu-item">
            <a
              href="https://demos.pixinvent.com/materialize-html-admin-template/html/front-pages/pricing-page.html"
              class="menu-link"
              target="_blank"
            >
          ...
          <li class="menu-item">
            <a
              href="https://demos.pixinvent.com/materialize-html-admin-template/html/front-pages/payment-page.html"
              class="menu-link"
              target="_blank"
            >
          ...
          <li class="menu-item">
            <a
              href="https://demos.pixinvent.com/materialize-html-admin-template/html/front-pages/checkout-page.html"
              class="menu-link"
              target="_blank"
            >
          ...
          <li class="menu-item">
            <a
              href="https://demos.pixinvent.com/materialize-html-admin-template/html/front-pages/help-center-landing.html"
              class="menu-link"
              target="_blank"
            >
