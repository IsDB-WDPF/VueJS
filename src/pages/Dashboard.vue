              ...
              <div class="col-md-12 col-xxl-8">
                <div class="card">
                  <div class="d-flex align-items-end row">
                    ...
                    <div
                      class="col-md-6 text-center text-md-end order-1 order-md-2"
                    >
                      <div class="card-body pb-0 px-0 pt-2">
                        <img
                          src="../../public/assets/img/illustrations/illustration-john-light.png"
                          height="186"
                          class="scaleX-n1-rtl"
                          alt="View Profile"
                        ...
                        <div class="row">
                          <div class="col-6 border-end">
                            <div class="d-flex flex-column align-items-center">
                              <div class="avatar">
                                <div
                                  class="avatar-initial bg-label-success rounded-3"
                                >
                                  <div
                                    class="ri-pie-chart-2-line ri-24px"
                                  ></div>
                                </div>
                              </div>
                          ...
                          <div class="col-6">
                            <div class="d-flex flex-column align-items-center">
                              <div class="avatar">
                                <div
                                  class="avatar-initial bg-label-primary rounded-3"
                                >
                                  <div
                                    class="ri-money-dollar-circle-line ri-24px"
                                  ></div>
                                </div>
                              </div>
                              <p class="mt-3 mb-1">This Week</p>
                      ...
                      <li class="d-flex align-items-center mb-6">
                        <div class="avatar avatar-md flex-shrink-0 me-4">
                          <div class="avatar-initial bg-light-gray rounded-3">
                            <div>
                              <img
                                src="../../public/assets/img/icons/misc/3d-illustration.png"
                                alt="User"
                                class="h-25"
                              />
                            </div>
                      ...
                      <li class="d-flex align-items-center mb-6">
                        <div class="avatar avatar-md flex-shrink-0 me-4">
                          <div class="avatar-initial bg-light-gray rounded-3">
                            <div>
                              <img
                                src="../../public/assets/img/icons/misc/finance-app-design.png"
                                alt="User"
                                class="h-25"
                              />
                            </div>
                      ...
                      <li class="d-flex align-items-center mb-6">
                        <div class="avatar avatar-md flex-shrink-0 me-4">
                          <div class="avatar-initial bg-light-gray rounded-3">
                            <div>
                              <img
                                src="../../public/assets/img/icons/misc/4-square.png"
                                alt="User"
                                class="h-25"
                              />
                            </div>
                      ...
                      <li class="d-flex align-items-center mb-6">
                        <div class="avatar avatar-md flex-shrink-0 me-4">
                          <div class="avatar-initial bg-light-gray rounded-3">
                            <div>
                              <img
                                src="../../public/assets/img/icons/misc/delta-web-app.png"
                                alt="User"
                                class="h-25"
                              />
                            </div>
                      ...
                      <li class="d-flex align-items-center">
                        <div class="avatar avatar-md flex-shrink-0 me-4">
                          <div class="avatar-initial bg-light-gray rounded-3">
                            <div>
                              <img
                                src="../../public/assets/img/icons/misc/ecommerce-website.png"
                                alt="User"
                                class="h-25"
                              />
                            </div>
              ...
              <div class="col-12 col-xxl-8">
                <div class="card h-100">
                  ...
                  <div class="card-body pb-0">
                    <ul
                      class="nav nav-tabs nav-tabs-widget pb-6 gap-4 mx-1 d-flex flex-nowrap"
                      role="tablist"
                    >
                      <li class="nav-item">
                        <a
                      ...
                      <li class="nav-item">
                        ...
                        >
                          <div class="avatar avatar-sm">
                            <img
                              src="../../public/assets/img/icons/brands/facebook-rounded.png"
                              alt="User"
                            />
                          </div>
                        </a>
                      ...
                      <li class="nav-item">
                        ...
                        >
                          <div class="avatar avatar-sm">
                            <img
                              src="../../public/assets/img/icons/brands/instagram-rounded.png"
                              alt="User"
                            />
                          </div>
                        </a>
                      ...
                      <li class="nav-item">
                        ...
                        >
                          <div class="avatar avatar-sm">
                            <img
                              src="../../public/assets/img/icons/brands/reddit-rounded.png"
                              alt="User"
                            />
                          </div>
                        </a>
                        ...
                        <table class="table border-top">
                          ...
                          <tbody class="table-border-bottom-0">
                            <tr>
                              ...
                              <td class="text-success fw-medium text-end">
                                +24%
                              </td>
                            ...
                            <tr>
                              ...
                              <td class="text-danger fw-medium text-end">
                                -12%
                              </td>
                  ...
                  <div class="card-body pt-xl-5">
                    ...
                    <div class="d-flex justify-content-between mt-6">
                      ...
                      <div class="avatar">
                        <div class="avatar-initial bg-label-warning rounded">
                          <i
                            class="ri-arrow-right-s-line ri-24px scaleX-n1-rtl"
                          ></i>
                        </div>
                      </div>
                    </div>
                        ...
                        <div class="timeline-event">
                          ...
                          <div class="d-flex align-items-center mb-1">
                            <div class="badge bg-lighter rounded-3">
                              <img
                                src="../../public/assets/img/icons/misc/pdf.png"
                                alt="img"
                                width="15"
                                class="me-2"
                              />
                              ...
                              <div class="d-flex flex-wrap align-items-center">
                                ...
                                >
                                  ...
                                  >
                                    <img
                                      class="rounded-circle"
                                      src="../../public/assets/img/avatars/12.png"
                                      alt="Avatar"
                                    />
                                  </li>
                                  <li
                                  ...
                                  >
                                    <img
                                      class="rounded-circle"
                                      src="../../public/assets/img/avatars/6.png"
                                      alt="Avatar"
                                    />
                                  </li>
                                  <li class="avatar">
